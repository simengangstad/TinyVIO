...
/**
 * LWIP_ALLOW_MEM_FREE_FROM_OTHER_CONTEXT=1: we need to free PBUF_RAM
 * pbufs from ISR context on LPC.
 */
...
#ifndef TCP_MSS
#define TCP_MSS                                                   \
    (1500 - 40) /* TCP_MSS = (Ethernet MTU - IP header size - TCP \
                   header size) */
#endif
 ...
 * passed to sys_mbox_new() when the recvmbox is created.
 */
