...
#define AT_QUICKACCESS_SECTION_CODE_ALLOW_INLINE(func) \
    __attribute__((section("CodeQuickAccess"))) func

#define AT_OCRAM_SECTION_DATA(var) \
    __attribute__((section(".data.$SRAM_OC"))) var

#define AT_RPMSG_SECTION_NOINIT(var) \
    __attribute__((section(".noinit.$RPMSG_SH_MEM"))) var
